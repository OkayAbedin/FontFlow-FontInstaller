...
def create_distribution_folder():
    ...
    utility_files = [
        ...
        ("test_registry_fix.py", "utilities/test_registry_fix.py"),
...
echo.
echo NEW in v1.1.0:
echo - Fonts now persist across computer reboots!
echo - Proper Windows registry registration
...
echo - test_registry_fix.py - Verify registry persistence fix
echo - create_test_fonts.py - Create test font files
echo.
echo Ready to install fonts that stay installed!
echo.
pause
'''
